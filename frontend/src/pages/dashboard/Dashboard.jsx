          ...
          <div className="col-md-10 col-12 py-3">
            ...
            <div className='text-center'>
              ...
              <div className="card notes overflow-auto scrollbar mt-4 text-start ">
                <div className=" p-3 mb-2 sticky-top bg-light shadow  lh-base" key={note._id}>
...

                {
                  ...
                  notes.map(note => (
                    <div className="   p-3 mb-2 shadow my-3  lh-base d-flex justify-content-between align-items-center" key={note._id}>
